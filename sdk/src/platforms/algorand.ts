import * as _algorand from "@ultronswap-wormhole/sdk-algorand";
...
const algorand: PlatformDefinition<typeof _algorand._platform> = {
  ...
  protocols: {
    WormholeCore: () => import("@ultronswap-wormhole/sdk-algorand-core"),
    TokenBridge: () => import("@ultronswap-wormhole/sdk-algorand-tokenbridge"),
  },
