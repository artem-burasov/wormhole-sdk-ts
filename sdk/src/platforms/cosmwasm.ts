...
import * as _cosmwasm from "@ultronswap-wormhole/sdk-cosmwasm";
...
const cosmwasm: PlatformDefinition<typeof _cosmwasm._platform> = {
  ...
  protocols: {
    WormholeCore: () => import("@ultronswap-wormhole/sdk-cosmwasm-core"),
    TokenBridge: () => import("@ultronswap-wormhole/sdk-cosmwasm-tokenbridge"),
    IbcBridge: () => import("@ultronswap-wormhole/sdk-cosmwasm-ibc"),
  },
